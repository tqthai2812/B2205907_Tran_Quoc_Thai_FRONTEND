...
export default {
    ...
    data() {
        ...
        return {
            contactFormSchema,
            contactLocal: {}, // ban đầu để trống, sẽ gán trong watch
        };
    },
    watch: {
        contact: {
            immediate: true,
            handler(newVal) {
                // sao chép dữ liệu contact vào biến local
    ...
    methods: {
        ...
        Cancel() {
            const reply = window.confirm("Bạn có muốn rời khỏi trang mà không lưu?");
            if (reply) {
